...
class ElementContainer {
    constructor(context, element, options = {}) {
        ...
        if (element.tagName === 'FIELDSET') {
            ...
            if (legend) {
                const legendBounds = (0, bounds_1.parseBounds)(this.context, legend);
                ...
                this.bounds = new bounds_1.Bounds(this.bounds.left, borderBoxTop, this.bounds.width, this.bounds.height - (borderBoxTop - this.bounds.top));
            }
        }
